...
# ╔═╡ 292586ba-f8a6-4f5c-8e73-ff1c36e7ce5a
begin
	using DataFrames
	using CSV
end

# ╔═╡ e6c30139-800c-4b65-b86a-b94eb206f333
using Plots  # This will install plots

# ╔═╡ 536eef56-755d-483e-a23d-21ca5c0ca518
using PlutoUI

# ╔═╡ e83f1815-4277-4d14-a68f-18868c232b63
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 51c38c55-b8e4-4808-8f5b-cb1e71482c82
df.Country_code === df[!, "Country_code"]

# ╔═╡ 8a8df288-f10c-471f-8e56-172aa79fee0f
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ f0836637-2a6c-4bf2-9bfc-a8a6fe10c957
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 61428637-b9fe-4a92-8163-2c8060c370dd
dates = sg_data[!, "Date_reported"]

# ╔═╡ cd35a82a-85e9-4ebf-a366-a7011a19f04c
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ ae4f4281-7f6e-4d1d-84a7-a25c8a720d02
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ 0b148e50-f640-4c2f-b3f6-be32eb6aaadb
...
# ╔═╡ a1aab23f-38ff-430f-b113-bd19a04ea3e3
@bind slider_value Slider(0:10:1000)

# ╔═╡ ce9e7ec9-54a4-4b8e-a5ed-040215dfe31d
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ ec0d0d1b-ad45-4b37-a1ff-f390527108cc
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ b917f008-31bb-4b1e-afbc-135edead3b05
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ 572ddc93-970e-43e2-a759-dd7271081406
